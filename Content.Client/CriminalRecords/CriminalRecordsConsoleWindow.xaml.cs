...
public sealed partial class CriminalRecordsConsoleWindow : FancyWindow
{
    ...
    private void PopulateRecordContainer(uint key, GeneralStationRecord stationRecord, CriminalRecord criminalRecord) // Pirate: cameras (photo in records)
    {
        ...
        PersonPrintsEdit.Text = stationRecord.Fingerprint ?? string.Empty;
        PersonDnaEdit.Text = stationRecord.DNA ?? string.Empty;
    ...
    private void UpdateRecordActionButtons()
    {
        ...
        AddRecordButton.Disabled = !_access || string.IsNullOrWhiteSpace(FilterText.Text);
